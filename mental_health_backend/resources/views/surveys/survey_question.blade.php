...
<div class="wrapper ">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="card">
                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="question_text" value="{{ $question->question }}">
                    </div>
            ...
            <div class="card" id="checkbox_options">
                <div class="container-fluid mt-4 mb-4 ml-2">
                    <div id="question_options">
                    @foreach($question->options as $option)
                        <div class="form-group option_inputs">
                            <input style="width: 500px" type="text" class="form-check-inline form-control option_text" data-new="F" data-id="{{ $option->id }}" id="option_text_{{$option->id}}" aria-describedby="" value="{{ $option->option_text }}" required>
                            <input style="width: 500px" type="text" class="form-check-inline form-control option_value" data-new="F" data-id="{{ $option->id }}" id="option_value_{{$option->id}}" aria-describedby="" value="{{ $option->option_value }}" required>
